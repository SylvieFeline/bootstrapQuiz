...
var urlQuizM2 = "http://localhost/sites/bootstrapQuiz/php/quizM.php";
...
if ((pageEnCours == urlQuizM1) || (pageEnCours == urlQuizM2)){
...
// auto-complétion champ recherche  (OpenClassrooms - dynamisez vos sites web avec JavaScript)
...
(function() {
    ...
    function getResults(keywords) { // Effectue une requête et récupère les résultats
        ...
        xhr.open('GET', '../request/search.php?s='+ encodeURIComponent(keywords));
