...
$message = $prenomMembre.' '.$nomMembre. ' vous soumets le quiz n° '.$idQuiz.' "<strong>'.$titre.'</strong>" pour validation. <br>';
...
$_SESSION['messageConfEnvoiQuiz'] = "Votre quiz a été transmis pour validation. <br>
 Vous serez informer par mail quand celui-ci aura été validé. <br>
 En attendant, vous pouvez le retrouvez sur votre page 'Mes quiz'. <br>
